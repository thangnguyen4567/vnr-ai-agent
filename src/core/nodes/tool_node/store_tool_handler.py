...
class StoreToolHandler(BaseToolHandler):
    ...
    async def process(
            ...
            store_tool_registry: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for tool_call_info in tool_calls_info:
                ...
                params = self._preprare_store_request_params(
                    tool_call_info,
                    store_tool_registry[tool_call_info.get("name")]
                )
                ...
                output_params = store_tool_registry[tool_call_info.get("name")].get("output_params", [])
    ...
    def _preprare_store_request_params(
        self, 
