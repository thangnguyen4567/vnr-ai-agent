...
class AgentConfigLoader:
    ...
    def _load_config(self) -> Dict[str, Any]:
        self._fc_config = ConfigReaderInstance.yaml.read_config_from_file("settings/fc_agent.yaml")
        self._multi_config = ConfigReaderInstance.yaml.read_config_from_file("settings/multi_agent.yaml")
